      ...
      >
        ...
        >
          ...
          <div className="w-full flex flex-col items-start gap-2">
            <label
              htmlFor="userName"
              className="text-[#000] text-sm font-medium"
            >
              ユーザー名
            </label>
          ...
          <div className="w-full flex flex-col items-start gap-3 mt-6">
            ...
            <button
              className="w-full rounded-[100px] border border-black py-3"
              type="button"
            ...
            >
              <span className="text-sm text-[#ff0000] font-medium text-center w-full">
                アカウント削除
              </span>
            </button>
          </div>
  ...
  return (
    <div className="px-5 relative">
      <div className="relative">
        ...
        {me?.id === user.id && (
          <div
            className="fixed top-28 right-4"
